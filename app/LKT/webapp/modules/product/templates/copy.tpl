...
<!--         <div class="row cl">
        ...
        <div class="row cl page_bort_bottom">
            <div class="col-8 col-offset-4">
                <input type="submit" name="Submit" value="提 交" class="btn btn-primary radius btn-right" onclick="check()" style="margin-right: 60px!important;">
