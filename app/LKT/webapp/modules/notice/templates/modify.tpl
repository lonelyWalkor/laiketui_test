...
<div class="pd-20">
    <form name="form1" action="index.php?module=coupon&action=modify" class="form form-horizontal" method="post" enctype="multipart/form-data"  onsubmit="return checkUser()" >
        ...
        <div class="row cl" id="time" style="display:{if $activity_type == 1}none{/if};">
            ...
            <div class="formControls col-6">
                <input name="start_time" id="start_time" value="{$start_time}" size="8" readonly class="scinput_s" style="width: 200px;height:26px;font-size: 14px;vertical-align: middle;" />
                <img src="modpub/images/datetime.gif" style="cursor:pointer;" onclick="new Calendar().show(document.form1.start_time);" />
                -
                <input name="end_time" id="end_time" value="{$end_time}" size="8" readonly  class="scinput_s" style="width: 200px;height:26px;font-size: 14px;vertical-align: middle;"/>
        ...
        <div class="row cl">
            <div class="col-10 col-offset-4">
                ...
                <button class="btn btn-secondary radius" type="button" onclick="resetButton()" name="reset"><i class="Hui-iconfont">&#xe632;</i> 重 写</button>
            </div>
        </div>
    </form>
</div>
