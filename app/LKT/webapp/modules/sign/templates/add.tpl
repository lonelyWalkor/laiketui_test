 ...
 * @LastEditTime: 2019-09-17 14:36:08
...
<body>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe623;</i> 签到活动管理 <span class="c-gray en">&gt;</span> 活动列表 <span
            class="c-gray en">&gt;</span> 添加活动 <a class="btn btn-success radius r mr-20"
            style="line-height:1.6em;margin-top:3px" href="#" onclick="location.href='index.php?module=sign';"
        ...
        <form name="form1" action="index.php?module=sign&action=add" class="form form-horizontal" method="post"
            ...
            <div class="row cl">
                ...
                <div class="formControls col-10">
                    <input id="start_time" name="starttime" value="" class="scinput_s"
                        style="width: 140px; height:26px;font-size: 14px;vertical-align: middle;" placeholder="开始时间">
                    -
                    <input id="end_time" name="endtime" value="" class="scinput_s"
                        style="width: 140px; height:26px;font-size: 14px;vertical-align: middle;" placeholder="结束时间">
            ...
            <div class="row cl">
                <div class="col-10 col-offset-2">
                    <button class="btn btn-primary radius" type="submit" name="Submit"><i
                            class="Hui-iconfont">&#xe632;</i> 提 交</button>
                    <button class="btn btn-secondary radius" type="reset" name="reset"><i
